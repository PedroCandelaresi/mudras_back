    ...
    try {
      ...
      `));
        ...
        for (const c of preview) {
            console.log(` - id=${c.id} codigo=${c.Codigo ?? '—'} marca="${c.Marca ?? ''}" -> autor`);
        }
        ...
        console.log(`[fix-libros-autor] OK. Registros actualizados: ${candidatos.length}. keepMarca=${keepMarca}`);
    }
    catch (error) {
...
void main();
//# sourceMappingURL=fix-libros-autor.js.map