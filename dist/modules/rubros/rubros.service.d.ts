...
export declare class RubrosService {
    ...
    create(nombre: string, codigo?: string, porcentajeRecargo?: number, porcentajeDescuento?: number, unidadMedida?: string): Promise<Rubro>;
    update(id: number, nombre: string, codigo?: string, porcentajeRecargo?: number, porcentajeDescuento?: number, unidadMedida?: string): Promise<Rubro>;
