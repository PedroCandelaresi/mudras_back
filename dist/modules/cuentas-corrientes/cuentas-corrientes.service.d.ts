...
export declare class CuentasCorrientesService {
    private cuentasCorrientesRepository;
    private movimientosRepository;
    constructor(cuentasCorrientesRepository: Repository<CuentaCorriente>, movimientosRepository: Repository<MovimientoCuentaCorriente>);
