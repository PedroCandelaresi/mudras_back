...
export class CreateMudrasAuthTables1714848000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      // mudras_auth_role_permissions (M:N)
      await queryRunner.query(`
      ...
      // mudras_auth_user_providers (OAuth)
      await queryRunner.query(`
